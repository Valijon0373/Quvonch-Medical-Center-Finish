...
const WomenCheckup = ({ isOpen, onClose, onRegister }) => {
  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        <h1 className="text-3xl font-bold mb-5 text-center">Ayollar uchun tekshiruv</h1>

        <p className="mb-4">
          Ayollar salomatligini baholashning asosiy sohalarini qamrab oluvchi tekshiruv: gormonal
          darajalar va vitaminlardan tortib, qalqonsimon bez, reproduktiv tizim va ichki
          organlargacha. Yillik profilaktik yordam, homiladorlikka tayyorgarlik ko'rish yoki
          alomatlar paydo bo'lganda mos keladi. Qulay format har bir alohida testdan o'tmasdan
        ...
        <ul className="text-left max-w-2xl list-disc list-inside pl-5">
          ...
          <li>
            HOMA insulin qarshiligini baholash: och qorninga glyukoza, och qorninga insulin,
            HOMA-IR ballari
          </li>
          <li>
            Qorin bo'shlig'i a'zolarining keng qamrovli ultratovush tekshiruvi (jigar, o't pufagi,
            oshqozon osti bezi, taloq)
          </li>
          <li>
            Qon tomirlarining rangli Doppler tekshiruvi bilan qalqonsimon bezning ultratovush
            tekshiruvi
          </li>
          <li>
            Genitouriya tizimining keng qamrovli ultratovush tekshiruvi (buyraklar, buyrak usti
            bezlari, siydik yo'llari, siydik pufagi)
          </li>
          ...
          <li>
            Barcha biomateriallardagi inson papillomavirusi 16,31,33,52,58,56,18,39,45,59,6,11,51,68
            (HPV) miqdoriy ko'rsatkichi
          </li>
