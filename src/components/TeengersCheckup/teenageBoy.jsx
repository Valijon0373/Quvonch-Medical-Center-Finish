...
const TeenageBoy = ({ isOpen, onClose, onRegister }) => {
  if (!isOpen) return null;

  const title = "O'smirlar uchun chek-ap (o'g'il bolalar)";

  const description =
    "O'smir yoshdagi o'g'il bolalar uchun mo'ljallangan kompleks tibbiy tekshiruv. Muntazam nazorat uchun ham, shuningdek sog'liq holati, bo'y o'sishi, kayfiyat yoki vazn o'zgarishlari kuzatilganda ham foydali.";

  const items = [
    "Umumiy qon tahlili (kengaytirilgan) (XN-1000, Sysmex, Yaponiya)",
    ...
    "Moyaklar va ularning qo'shimchalari UZI (dopplerografiya bilan)",
    "Pediatr konsultatsiyasi",
    "Tor mutaxassislar konsultatsiyasi – tanlov asosida 5 ta: nevrolog, kardio-revmatolog, endokrinolog, bolalar urologi, gastroenterolog, oftalmolog, LOR, ortoped, allergolog",
  ];
  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        <p className="mb-4">
          Narxi: 4 800 000 UZS <span className="line-through text-gray-500 ml-2">5 670 000 UZS</span>
        </p>
