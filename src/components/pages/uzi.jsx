...
export default function UZI({ onDoctorClick, onNavigate }) {
  ...
  // UZI shifokorlarini API'dan yuklash
  useEffect(() => {
    ...
    const fetchDoctors = async () => {
      try {
        ...
        while (nextUrl) {
          ...
          // Faqat UZI yo'nalishidagi shifokorlar
          const uziDoctors = mapped.filter((doc) =>
            (doc.specialty || '').toUpperCase().includes('UZI')
          )

          allDoctors.push(...uziDoctors)
          nextUrl = data.next
        }
  ...
  return (
    <div className="min-h-screen bg-white mt-24">
      <Navbar onNavigate={onNavigate} currentSection="uzi" />
          ...
          rounded-3xl p-6 md:p-10 lg:p-16 shadow-2xl relative">
            ...
            <div className="md:hidden text-center text-white">
              ...
              <p className="text-sm sm:text-base leading-relaxed mb-8 text-white/90 px-2">
                UZI diagnostikasi — bu to'qimalar va organlarning holatini ultratovush to'lqinlari yordamida o'rganish jarayonidir. Ultratovush turli to'qimalar chegaralaridan o'tganda qaytadi. Ushbu o'zgarishlarni maxsus datchik qayd etadi. Aynan shu qaytgan signallar tekshiruv davomida olingan tasvirning asosini tashkil etadi.
              ...
              <div className="absolute bottom-4 left-4 text-sm text-white/80">
                <div className="flex items-center gap-2">
                  ...
                  <span>/</span>
                  <span className="font-medium text-white">UZI Diagnostikasi</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-black mb-4">Bizning UZI Mutaxasislarimiz</h2>
          ...
          <div className="md:hidden">
            {loadingDoctors ? (
              ...
              <div className="text-center text-gray-600">UZI bo'yicha shifokorlar topilmadi</div>
            ) : (
          ...
          <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {loadingDoctors ? (
              ...
              <div className="col-span-full text-center text-gray-600">UZI bo'yicha shifokorlar topilmadi</div>
            ) : (
              doctors.map((doctor) => (
                <div 
                  key={doctor.id}
      ...
      {/* Clinic Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 rounded-lg max-w-7xl mx-auto px-4">
        {clinicBranches.map((branch) => (
          <div key={branch.id} className="bg-blue-500 text-white p-6 rounded-lg hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>{branch.city}</p>
              <p>{branch.district},</p>
              <p className="font-semibold">Mo'ljal: {branch.landmark}</p>
            </div>
          </div>
        ))}
      </div>
